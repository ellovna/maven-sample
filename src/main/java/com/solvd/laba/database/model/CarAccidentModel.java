...
public class CarAccidentModel {
    ...
    public CarAccidentModel(){

    }
    private List<CarAccidentModel> carAccidentModel;
    ...
    public List<CarAccidentModel> getCarAccidentModel() {
        return carAccidentModel;
    }

    public void setCarAccidentModel(List<CarAccidentModel> carAccidentModel) {
        this.carAccidentModel = carAccidentModel;
    }
    ...
    public String toString() {
        return "CarAccidentModel{" +
                ...
                ", carAccidentModel=" + carAccidentModel +
                '}';
    }
